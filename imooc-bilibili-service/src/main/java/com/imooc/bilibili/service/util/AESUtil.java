 ...
 * 最常见的对称加密算法，即加密和解密使用同样的密钥，加密结果可逆(可逆？加密之后是可以用明文再解密回来的，不是说加密之后就没办法还原成加密之前的内容了)
 * 特点：加密速度非常快，适合经常发送数据的场合(比如频繁的数据请求交互)
 */
public class AESUtil {
    ...
    public String encrypt(String content) throws Exception {//主要用到这个方法
